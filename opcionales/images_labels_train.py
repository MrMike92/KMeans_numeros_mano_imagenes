...
# Programa que junta las caracteristicas de las imagenes con sus respectivas etiquetas de ENTRENAMIENTO en un archivo CVS
...
# Uso del script
features = idx3_to_features('date/train-images-idx3-ubyte/train-images-idx3-ubyte')
labels = idx1_to_labels('date/train-labels-idx1-ubyte/train-labels-idx1-ubyte')
combine_data(features, labels, 'train_labels.csv')
